...
export function renderGameSelector(onSelect) {
    ...
    GAMES.forEach(g => {
        ...
        name.style.cssText = 'color:white;margin:0 0 8px 0;font-size:18px;';
        const desc = document.createElement('p');
        desc.textContent = g.description;
        desc.style.cssText = 'color:#a0aec0;margin:0;font-size:13px;';
...
export function destroyActiveGame() {
    ...
    ads.forEach(id => { const el = document.getElementById(id); if (el)
        el.remove(); });
}
